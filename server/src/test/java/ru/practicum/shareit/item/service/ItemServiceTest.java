...
class ItemServiceTest {
    ...
    void createItemWithRequest() {
        ItemRequestDto request = new ItemRequestDto(null, "request", null, LocalDateTime.now(), null);
        request = itemRequestService.addRequest(userDto.getId(), request);
        ItemDto item = new ItemDto(null, "item uniq", "desc",
    ...
    @Test
    void createComment() {
        CommentDto comment = new CommentDto(null, "comment", null, LocalDateTime.now());
